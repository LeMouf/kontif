...
test('recorded npm metadata does not erase unresolved candidate evidence', () => {
  assert.ok(registry.components[0].evidence.some(e => e.url === 'https://registry.npmjs.org/@konitif%2fcore/0.284.2'));
  assert.ok(registry.components[0].unknowns.length > 0);
